...
var questions = [{
  ...
  "During WW1, in order to not be heard by the enemy, soldiers would bite on a bullet to keep from making a sound",
   "Pre 18th century soldiers would need to bite down on their bullets before they loaded their muskets in order to load properly"],
  correctAnswer: 0
}, {
  question: "Caught red handed",
  choices: [
    "Painters that created a poor canvas for their client and tried to cover it up were considered frauds and labeled as 'caught red handed'",
  ...
  "Eskimos often bathe in frigid open waters. Eskimos that forget their towel are usually made fun of, in return, they give those people their cold shoulder to look at",
  ...
  choices: [
    "On pirate ships, the distance a prisoner walks from the cells to the end of the plank was sidered the whole nine yards",
  ...
  choices: [
    ...
    "Polyneseans built thier homes our to sticks, mud and palms. After a hurrican would blow through, the massive amounts of debris left behind was enough to build their villages; they would often say it was more than you can shake a stick at", 
